        ...
        <div style={{ paddingBottom: "var(--floating-nav-h, 0px)" }}>
          <Routes>
            ...
            <Route
              ...
              element={
                <RequireQueryParams required={["email", "otp"]}>
                  {" "}
                  <LoginPage />{" "}
                </RequireQueryParams>
              }
            ...
            <Route
              path="/find-companion/:workshopId"
              element={<FindCompanion />}
            />
            ...
            <Route
              path="/host/create-workshop"
              element={<HostCreateWorkshop />}
            />
            <Route path="/host/schedule" element={<HostScheduleManagement />} />
            <Route
              path="/host/workshops/:workshopId/participants"
              element={<HostManageParticipants />}
            />
