        ...
        <main className="flex-grow flex flex-col items-center justify-start pt-10 pb-20 px-4">
          ...
          <div className="text-center max-w-2xl mx-auto mb-10 relative">
            ...
            <h1 className="text-3xl md:text-5xl font-black mb-4 tracking-tight">
              {isError ? "Thanh toán thất bại ❌" : isCancel ? "Giao dịch đã bị hủy ⚠️" : "Đã xác nhận đặt chỗ! 🎉"}
            </h1>
            <p className="text-slate-600 text-lg">
              {isError 
                ...
                : isCancel 
                  ...
                  : (
                    <>
                      Sẵn sàng để bắt tay vào việc thôi! Chúng tôi đã gửi email xác nhận đến{" "}
          ...
          {/* E-Ticket and Secondary Actions - Render ONLY on Success */}
          {!(isError || isCancel) && (
            <>
              {/* E-Ticket Container */}
              <div
