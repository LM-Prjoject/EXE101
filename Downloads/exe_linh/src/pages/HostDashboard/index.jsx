    ...
    <>
      <div className="bg-background-light text-text-main h-screen overflow-hidden flex">
        ...
        <main className="flex-1 flex flex-col h-screen overflow-hidden">
          <HostHeader title="Bảng điều khiển" />
          <div className="flex-1 overflow-y-auto bg-background-light p-8 lg:p-12">
                  ...
                  <div className="bg-surface-light rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <div className="divide-y divide-gray-100">
                      ...
                      <div className="p-4 sm:p-6 flex flex-col sm:flex-row gap-4 sm:items-center group hover:bg-gray-50 transition-colors">
                        <div className="h-16 w-16 sm:h-20 sm:w-20 rounded-xl bg-gray-200 bg-cover bg-center shrink-0 shadow-sm" data-alt="Hands working on a pottery wheel with clay" style={{ backgroundImage: `url('https://lh3.googleusercontent.com/aida-public/AB6AXuDbDKaFrFVXqSMO-GHo3Xq6KQGIOT6piFrdP471RPb3_puk80MKZd5zEytldrcF5OgwO4wn2uVMd5uBcqC5iZaICzSPzIQwhRFP36yxhGQAE6QqRKXikTvj1f93Fv3EPiDLz7fknIoJOxrb85a5YNV3-oUDvN92bIqEhDBjG326YXt2smvlAea_fEn651Wj7iVTwtv1OdoVyaeiV2FEjzM_Op-lJi33T1077qkdscQ-63-Qn3-5M25kMS9n6QMn5TZdtVhAU9eVbPvX')` }}></div>
                      ...
                      {/* Workshop Item 2 */}
                      <div className="p-4 sm:p-6 flex flex-col sm:flex-row gap-4 sm:items-center group hover:bg-gray-50 transition-colors">
                        <div className="h-16 w-16 sm:h-20 sm:w-20 rounded-xl bg-gray-200 bg-cover bg-center shrink-0 shadow-sm" data-alt="Abstract painting on canvas with colorful acrylics" style={{ backgroundImage: `url('https://lh3.googleusercontent.com/aida-public/AB6AXuBZ-2ire9Z6_BoWCHX18qTayPoyKn50XAy5cYYU8Qy5pg7CYkknYVSLkJnLoeV8hr4Cf_HLDXPSQkH8SN1HveDRnjoTl6SG9khEHl48LaR_PzD5glse0r9xVKSlain6VxVYxD1jCXIdOqaXTYeFM-Ryxk13p-EXYRdysQSSPEM_tXrJ9P0VMgEffXVq9p00HKO8_ff5SU7dP1Q-1wAggdGnAoWS1RrNIQZ4ZJX72BeTfQLAoyhWPtiToSWpJEzqnTY5bdeCpL11ldts')` }}></div>
                        <div className="flex-1 min-w-0">
